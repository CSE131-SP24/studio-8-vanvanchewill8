...
public class SelectAllQuestion extends MultipleChoiceQuestion {
	...
	public int checkAnswer(String givenAnswer) {
		int missCorrect = findMissingCorrectAnswers(givenAnswer);
		int missInc = findIncorrectGivenAnswers(givenAnswer);
		int earnedPoints = this.getPoints() - missCorrect - missInc;
		return earnedPoints;
	}
